...
tellraw @s[scores={LANGUAGE=0}] {"text":" °-° Elisa Meli : ","color":"green","extra":[{"text":"Hein quoi ! C'est pas moi qui ai, non je veux dire... Mais de quel droit un idiot comme... Vous ne seriez pas d'la garde !? Attendez, non, je vous en supplie ne me mettez pas en prison, je ne voulais pas faire de mal à ses chevaux !","color":"dark_aqua"}]}
