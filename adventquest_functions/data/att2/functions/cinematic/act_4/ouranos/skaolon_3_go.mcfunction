...
execute if score Real0 TIMER matches 511 if entity @e[nbt={UUIDMost:4746L,UUIDLeast:4746L},x=7604,y=107,z=6726,distance=..0.7] run function att2:cinematic/real0_iteration
...
execute if score Real0 TIMER matches 512 if entity @e[nbt={UUIDMost:4746L,UUIDLeast:4746L},x=7610,y=106,z=6734,distance=..0.7] run function att2:cinematic/real0_iteration
...
execute if score Real0 TIMER matches 513 if entity @e[nbt={UUIDMost:4746L,UUIDLeast:4746L},x=7609,y=106,z=6764,distance=..0.7] run function att2:cinematic/real0_iteration
...
execute if score Real0 TIMER matches 514 if entity @e[nbt={UUIDMost:4746L,UUIDLeast:4746L},x=7609,y=99,z=6771,distance=..0.7] run function att2:cinematic/real0_iteration
