####################################	*#
#Spawner for att2:summon/reg_1/creeper2_class17	#
####################################	*#
...
execute positioned -7392 105 -4456 unless entity @e[team=hostile,distance=..15,scores={COUNT=1..}] run function att2:summon/reg_1/creeper2_class17
