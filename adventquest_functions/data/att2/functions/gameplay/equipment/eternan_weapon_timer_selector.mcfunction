...
execute as @s[nbt={SelectedItem:{tag:{Manufacturer:"eternan",Rarity:"epi"}}}] run scoreboard players set @s ETERN_WEP_TIMER 175
execute as @s[nbt={SelectedItem:{tag:{Manufacturer:"eternan",Rarity:"leg"}}}] run scoreboard players set @s ETERN_WEP_TIMER 225