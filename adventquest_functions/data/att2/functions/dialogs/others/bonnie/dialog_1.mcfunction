...
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Bonnie : ","color":"green","extra":[{"text":"","color":"dark_aqua","extra":[{"text":" [貿易 -->]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/recycler/ask"},"hoverEvent":{"action":"show_text","value":"與 Bonnie 打交道"}}]}]}