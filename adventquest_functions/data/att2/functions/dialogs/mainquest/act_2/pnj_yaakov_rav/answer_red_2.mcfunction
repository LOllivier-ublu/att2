...
tellraw @a[scores={LANGUAGE=0}] {"text":"°-° Yaakov Rav : ","color":"green","extra":[{"text":"Oui il y a un moyen de l'activer. Il faut 3 fragments de pierres appellés : ''Gemme d'espace''. Elles sont malheureusement éparpillées dans le monde entier.","color":"dark_aqua"}]}
