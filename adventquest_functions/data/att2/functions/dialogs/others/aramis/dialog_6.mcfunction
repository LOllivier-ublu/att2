...
tellraw @s[scores={LANGUAGE=0}] {"text":" °-° Aramis : ","color":"green","extra":[{"text":"Êtes-vous satisfait de votre nouvelle demeure ? Vous n'êtes pas obliger de répondre par l'affirmatif... Beaucoup ont décidé de quitter la ville découragés par les difficiles conditions de l'environnement...","color":"dark_aqua"}]}
