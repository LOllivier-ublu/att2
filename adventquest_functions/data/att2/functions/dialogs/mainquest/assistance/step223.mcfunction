...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"The village chief of Kortaek showed me the way to Nojelanth. I have to rush into the grand canyon and go to the bottom in a cave.","color":"aqua","bold":false}]}