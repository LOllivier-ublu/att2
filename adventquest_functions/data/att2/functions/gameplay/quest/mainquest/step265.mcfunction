...
execute in minecraft:overworld positioned -7437 158 -5878 run function att2:gameplay/gps/summon_arrow
execute in minecraft:overworld as @e[tag=newGPS] at @s anchored feet facing -7437 158 -5878 run function att2:gameplay/gps/tp_arrow
