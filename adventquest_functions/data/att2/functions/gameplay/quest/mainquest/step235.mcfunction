...
execute if entity @s[scores={DIMENSION=1}] in minecraft:overworld positioned -5909 126 -4367 run function att2:gameplay/quest/mainquest/show_main_objective
execute if entity @s[scores={DIMENSION=0}] in minecraft:overworld positioned -7406 126 -4370 run function att2:gameplay/quest/mainquest/show_main_objective
