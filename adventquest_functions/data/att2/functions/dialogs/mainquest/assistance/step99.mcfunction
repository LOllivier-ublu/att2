...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"Now I have repelled the attack of monsters at Eolorion but I have to check if they are all dead ...","color":"aqua","bold":false}]}