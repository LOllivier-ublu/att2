#################################################################
#Made by Adventquest											#
#Use function to process the sell of diamond_pickaxe_115 		#
#################################################################

execute as @s[scores={CHRONOTON=..641}] at @s run function att2:dialogs/gameplay/shop/not_enough_chronotons
