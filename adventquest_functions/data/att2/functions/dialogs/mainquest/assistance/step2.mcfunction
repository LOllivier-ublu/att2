...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"I have to go down to the reserve of the inn in the basement to get rid of the spider's nest. So Gonon can at least give me some food and a room for the night.","color":"aqua"}]}