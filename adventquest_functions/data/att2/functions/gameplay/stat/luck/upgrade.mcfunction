...
execute as @s[scores={LUC_BASE=7}] if entity @s[scores={SKILLPOINT=15..}] run function att2:gameplay/stat/luck/lvl/8
execute as @s[scores={LUC_BASE=6}] if entity @s[scores={SKILLPOINT=15..}] run function att2:gameplay/stat/luck/lvl/7
