...
execute if score Real2 TIMER matches 100 positioned -3855 87 -6042 run summon minecraft:zombie_pigman ~ ~ ~ {Rotation:[32.0f,15.0f],NoAI:1,Invulnerable:1,CustomName:"\"ALPHONSE RAE\"",CustomNameVisible:1,Silent:1,PersistenceRequired:1,Attributes:[{Name:generic.attackDamage,Base:0.0},{Name:generic.maxHealth,Base:1.0}],Health:1,ArmorItems:[{id:"minecraft:leather_boots",Count:1,tag:{display:{color:8015155}}},{id:"minecraft:leather_leggings",Count:1,tag:{display:{color:8015155}}},{id:"minecraft:leather_chestplate",Count:1,tag:{display:{color:8015155}}},{id:"minecraft:player_head",Count:1,tag:{SkullOwner:{Id:"d73f23c0-cd68-5f0a-9fe5-b5980e02d722",Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOGI2OTEzZjExMTJkZjliNTkxNTM0MmY3NWUyNjY1YjVmNzc4MTk4M2E4NTI3MDQ4YTg5MjMxMTkwMTBjYTI4In19fQ=="}]}}}}]}
