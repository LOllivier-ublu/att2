...
execute if score Real0 TIMER matches 60 run playsound screeching master @a ~-20 ~ ~40 3 1 1
execute if score Real0 TIMER matches 60 run playsound siren2 master @a ~-20 ~ ~40 3 1 1
