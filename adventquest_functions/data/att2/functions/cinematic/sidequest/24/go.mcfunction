...
execute if score SQ24 SIDEQUEST matches 3 if entity @a[x=-4518,y=59,z=-4536,dx=-21,dy=9,dz=-27,gamemode=adventure] unless entity @e[type=minecraft:witch,nbt={UUIDMost:60L,UUIDLeast:60L}] run function att2:cinematic/sidequest/24/end
