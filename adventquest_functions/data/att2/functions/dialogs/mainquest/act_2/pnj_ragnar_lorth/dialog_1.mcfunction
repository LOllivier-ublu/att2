...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"Salutation. Wirth Razgork, un ami d'Indra, m'a envoyé la rencontrer. Je...","color":"aqua"}]}
...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"Greetings. Wirth Razgork, a friend of Indra's, sent me to meet her. I...","color":"aqua"}]}
