...
particle minecraft:falling_dust minecraft:dirt ~ ~0.5 ~ 9 0.5 9 0 200 normal
particle minecraft:falling_dust minecraft:dark_oak_wood ~ ~0.5 ~ 9 0.5 9 0 200 normal
particle minecraft:falling_dust minecraft:gray_concrete ~ ~0.5 ~ 9 0.5 9 0 200 normal
particle minecraft:item minecraft:iron_block ~ ~0.5 ~ 10 0.25 10 0.5 200 normal
particle minecraft:item minecraft:gray_concrete ~ ~0.5 ~ 10 0.25 10 0.5 200 normal
particle minecraft:item minecraft:dirt ~ ~0.5 ~ 10 0.25 10 0.5 200 normal
