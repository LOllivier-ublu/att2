...
function att2:summon/bat_superelite16_reg4_rewards
function att2:summon/bat_superelite16_reg4_rewards
execute if score level DIFFICULTY matches 0.. run function att2:summon/bat_superelite16_reg4_rewards
execute if score level DIFFICULTY matches 1.. run function att2:summon/bat_superelite16_reg4_rewards
execute if score level DIFFICULTY matches 2.. run function att2:summon/bat_superelite16_reg4_rewards
