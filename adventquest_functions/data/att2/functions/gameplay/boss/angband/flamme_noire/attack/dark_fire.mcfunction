...
execute if score FlammeNoire ANGOR_BOSS matches 130 as @e[type=minecraft:zombie_pigman,nbt={UUIDMost:91L,UUIDLeast:123L}] at @s run teleport @s 3517.3 55.6 4931
execute if score FlammeNoire ANGOR_BOSS matches 130 as @e[type=minecraft:zombie_pigman,nbt={UUIDMost:91L,UUIDLeast:139L}] at @s run teleport @s 3510.7 55.6 4931
...
execute if score FlammeNoire ANGOR_BOSS matches 1 as @e[type=minecraft:zombie_pigman,nbt={UUIDMost:91L,UUIDLeast:123L}] at @s run teleport @s 3517.3 54.6 4931
execute if score FlammeNoire ANGOR_BOSS matches 1 as @e[type=minecraft:zombie_pigman,nbt={UUIDMost:91L,UUIDLeast:139L}] at @s run teleport @s 3510.7 54.6 4931
