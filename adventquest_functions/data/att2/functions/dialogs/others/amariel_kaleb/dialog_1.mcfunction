...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@s","color":"gray","extra":[{"text":" : "},{"text":"[Payer la chambre et se reposer --> 40 Chronotons]","color":"yellow","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-111a-0000-00000000111a if entity @s[distance=..7] as @a[distance=..7] run function att2:dialogs/others/amariel_kaleb/answer_green"},"hoverEvent":{"action":"show_text","value":"Cliquez ici pour payer la chambre et se reposer à l'auberge."}}]}
