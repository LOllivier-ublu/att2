...
tellraw @s[scores={LANGUAGE=0}] {"text":"°-° Viserys Yigdal : ","color":"green","extra":[{"text":"Bonjour, je peux vous faire de bon plats cuisinés et si vous avez besoin de viande cuite j'en vends également.","color":"dark_aqua","extra":[{"text":" [Voir la marchandise -->]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/shop/seller/viserys_yigdal_shop_opening"},"hoverEvent":{"action":"show_text","value":"Cliquez ici pour voir ce que vend Viserys."}}]}]}
