...
tellraw @s[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[ -->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-149a-0000-00000000149a if entity @s[distance=..10,nbt={SelectedItem:{tag:{EquipmentType:\"meleeWeapon\",Rarity:\"leg\",Manufacturer:\"eternan\",Effect:\"str2_has4\"}}}] if score SQ45 SIDEQUEST matches 4 run function att2:cinematic/sidequest/45/aldelrion/answer_1_2"},"hoverEvent":{"action":"show_text","value":"點擊這裡 - 回答 1"}}]}