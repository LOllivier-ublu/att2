...
tellraw @s[scores={LANGUAGE=0}] {"text":"°-° Célestine : ","color":"green","extra":[{"text":"Hé, montrez-moi donc ce que vous portez ! Hm. Ça pourrait m'intéresser, ça... Non ? Vous ne voulez pas me vendre tout votre équipement ? Enfin, si vous avez autres choses d'aussi profitable à me vendre, je serais ravis de faire affaire avec vous.","color":"dark_aqua","extra":[{"text":" [Echanger -->]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/recycler/ask"},"hoverEvent":{"action":"show_text","value":"Cliquez ici pour commencer l'échange avec Célestine."}}]}]}
