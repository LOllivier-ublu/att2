...
execute if score Real0 TIMER matches 200 run function att2:dialogs/title/a4_ch4_title1
execute if score Real0 TIMER matches 200 run function att2:dialogs/title/a4_ch4_subtitle1
