...
tellraw @s[scores={LANGUAGE=0}] {"text":"-°- Les catacombes Adanoï -°- : ","color":"gray","extra":[{"text":"Myrath, cet être mort-vivant, a parlé d'une voleuse. Par aileurs, Méleïm est mentionnée dans l'invitation de Myrath. Voilà de très bonnes pistes pour la suite. Retournons voir Emerald à l'entrée du cimetière au sud.","color":"aqua","italic":true}]}
