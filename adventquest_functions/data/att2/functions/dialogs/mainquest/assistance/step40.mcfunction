...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"I have activated all the pillars of the room, but the traps are not open... Something must be blocking them, as long as it's not the wear and tear of time. However, I can now go to the last wing of the temple....","color":"aqua","bold":false}]}