...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"Evidently, I was transported into this temporality of a future which seems to me extremely distant. I have to get out of there by the passages, I have no choice ...","color":"aqua","bold":false}]}