...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@s","color":"gray","extra":[{"text":" : "},{"text":"En effet, j'ai besoin que ta cargaison arrive jusqu'à Eolorion.","color":"aqua"}]}
...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@s","color":"gray","extra":[{"text":" : "},{"text":"Indeed, I need your cargo to arrive at Eolorion.","color":"aqua"}]}
