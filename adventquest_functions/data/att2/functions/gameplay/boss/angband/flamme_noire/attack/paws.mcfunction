...
execute if score FlammeNoire ANGOR_BOSS matches 180 as @e[type=minecraft:zombie_pigman,nbt={UUIDMost:91L,UUIDLeast:123L}] at @s run teleport @s 3517.3 71.6 4943 165 30
execute if score FlammeNoire ANGOR_BOSS matches 180 as @e[type=minecraft:zombie_pigman,nbt={UUIDMost:91L,UUIDLeast:139L}] at @s run teleport @s 3510.7 71.6 4943 165 30
...
execute if score FlammeNoire ANGOR_BOSS matches 20 as @e[type=minecraft:zombie_pigman,nbt={UUIDMost:91L,UUIDLeast:123L}] at @s run teleport @s 3517.3 54.6 4931
execute if score FlammeNoire ANGOR_BOSS matches 20 as @e[type=minecraft:zombie_pigman,nbt={UUIDMost:91L,UUIDLeast:139L}] at @s run teleport @s 3510.7 54.6 4931
...
execute if score FlammeNoire ANGOR_BOSS matches 10 in minecraft:the_nether run particle minecraft:item minecraft:nether_bricks 3524 41 4906 0.5 0.2 0.5 1 300
execute if score FlammeNoire ANGOR_BOSS matches 10 in minecraft:the_nether run particle minecraft:instant_effect 3524 41 4906 1 0.2 1 0.1 50
execute if score FlammeNoire ANGOR_BOSS matches 9 in minecraft:the_nether run particle minecraft:instant_effect 3524 41 4906 2 0.2 2 0.1 50
execute if score FlammeNoire ANGOR_BOSS matches 8 in minecraft:the_nether run particle minecraft:instant_effect 3524 41 4906 3 0.2 3 0.1 50
execute if score FlammeNoire ANGOR_BOSS matches 7 in minecraft:the_nether run particle minecraft:instant_effect 3524 41 4906 4 0.2 4 0.1 100
execute if score FlammeNoire ANGOR_BOSS matches 6 in minecraft:the_nether run particle minecraft:instant_effect 3524 41 4906 5 0.2 5 0.1 100
execute if score FlammeNoire ANGOR_BOSS matches 5 in minecraft:the_nether run particle minecraft:instant_effect 3524 41 4906 6 0.2 6 0.1 200
