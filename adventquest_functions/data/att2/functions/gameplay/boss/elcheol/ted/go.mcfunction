...
execute if score Ted SQ55 matches 0.. if entity @a[x=-5076,y=91,z=-6171,dx=-50,dy=32,dz=-56,gamemode=adventure] store result bossbar minecraft:ted max run data get entity 00000000-0000-023c-0000-00000000023c Attributes[0].Base
...
execute if score Ted SQ55 matches 0.. if entity @a[x=-5076,y=91,z=-6171,dx=-50,dy=32,dz=-56,gamemode=adventure] store result bossbar minecraft:skrappy1 max run data get entity 00000000-0000-024c-0000-00000000024c Attributes[0].Base
...
execute if score Ted SQ55 matches 0.. if entity @a[x=-5076,y=91,z=-6171,dx=-50,dy=32,dz=-56,gamemode=adventure] store result bossbar minecraft:skrappy2 max run data get entity 00000000-0000-025c-0000-00000000025c Attributes[0].Base
...
# Testing if Ted died
execute if score Ted SQ55 matches 0.. if entity @a[x=-5076,y=91,z=-6171,dx=-50,dy=32,dz=-56,gamemode=adventure] unless entity @e[x=-5076,y=91,z=-6171,dx=-50,dy=32,dz=-56,nbt={UUIDMost:572L,UUIDLeast:572L}] unless entity @e[x=-5076,y=91,z=-6171,dx=-50,dy=32,dz=-56,nbt={UUIDMost:588L,UUIDLeast:588L}] unless entity @e[x=-5076,y=91,z=-6171,dx=-50,dy=32,dz=-56,nbt={UUIDMost:604L,UUIDLeast:604L}] run function att2:gameplay/boss/elcheol/ted/victory
