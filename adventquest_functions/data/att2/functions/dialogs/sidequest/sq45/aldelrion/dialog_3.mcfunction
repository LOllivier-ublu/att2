...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@s","color":"gray","extra":[{"text":" : "},{"text":"Je comprends pourquoi vous vouliez la retrouver. C'est un outil magnifique.","color":"aqua"}]}
...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@s","color":"gray","extra":[{"text":" : "},{"text":"I understand why you wanted to recover it. It's truly a magnificent tool.","color":"aqua"}]}
