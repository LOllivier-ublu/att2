...
execute if score Timer3 SERILE matches 1 as 00000000-0000-022b-0000-00000000022b at @s run data merge entity @s {NoAI:0,Attributes:[{Name:generic.attack_damage,Base:30.0},{name:generic.movement_speed,Base:30.0}]}
...
execute if score Timer3 SERILE matches 400 as 00000000-0000-022b-0000-00000000022b run data merge entity @s {NoAI:0,Attributes:[{Name:generic.attack_damage,Base:20.0},{name:generic.movement_speed,Base:25.0}]}
