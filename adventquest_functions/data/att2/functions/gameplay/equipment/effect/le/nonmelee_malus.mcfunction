...
execute unless entity @s[nbt={SelectedItem:{tag:{EquipmentType:"rangeWeapon"}}}] unless entity @s[scores={SPELL_SLCT=1..10},nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§4◸§8/ §4◞§c⎝§4⸜ §8\\§4◹\"}","{\"text\":\"§8⧼  §4〈§c✧§4〉  §8⧽\"}","{\"text\":\"§4◺§8\\§4 ᐠ§c⎞§4◜ §8/§4◿\"}"]}}}}] unless entity @s[scores={SERILE_BONUS1=1..}] unless entity @s[scores={SERILE_BONUS2=1..}] run function att2:gameplay/equipment/effect/le/any_malus