...
execute if score Illusion_timer1 SILBERLAND matches 1000 as @a[x=-4217,y=9,z=-5652,dx=-70,dy=33,dz=64,gamemode=adventure] at @s run effect give @s minecraft:blindness 20 0 true
