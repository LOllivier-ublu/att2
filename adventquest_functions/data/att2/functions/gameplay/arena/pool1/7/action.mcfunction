...
execute as @e[x=5292,y=70,z=-5040,dx=80,dy=55,dz=80,tag=Asurok,limit=1] if entity @s[nbt={AbsorptionAmount:0.0f}] run data merge entity @s {AbsorptionAmount:30.0f}
execute as @e[x=5292,y=70,z=-5040,dx=80,dy=55,dz=80,tag=Torkant,limit=1] if entity @s[nbt={AbsorptionAmount:0.0f}] run data merge entity @s {AbsorptionAmount:30.0f}
execute as @e[x=5292,y=70,z=-5040,dx=80,dy=55,dz=80,tag=Blobby,limit=1] if entity @s[nbt={AbsorptionAmount:0.0f}] run data merge entity @s {AbsorptionAmount:30.0f}