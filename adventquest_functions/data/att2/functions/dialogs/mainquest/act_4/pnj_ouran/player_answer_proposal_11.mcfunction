...
tellraw @s[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[ -->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-017b-0000-00000000017b if entity @s[distance=..30] if score ouran_PNJ DIALOG matches 5 run function att2:dialogs/mainquest/act_4/pnj_ouran/dialog_11"},"hoverEvent":{"action":"show_text","value":"點擊這裡 - 回答 2"}}]}