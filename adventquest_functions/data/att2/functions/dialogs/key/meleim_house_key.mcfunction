...
tellraw @a[scores={LANGUAGE=1}] {"selector":"@s","color":"gray","extra":[{"text":" : "},{"text":"I need a ","color":"aqua","extra":[{"text":"<Little Key>","color":"gray","hoverEvent":{"action":"show_item","value":"{\"id\":\"minecraft:brick\",\"Count\":1,\"tag\":{\"display\":{\"Name\":\"{\\\"text\\\":\\\"§9Clef Maison Méleïm\\\"}\",\"Lore\":[\"{\\\"text\\\":\\\"§3§oKey of Meleïm House\\\"}\"]}}}"},"extra":[{"text":" to open this door!","color":"aqua"}]}]}]}