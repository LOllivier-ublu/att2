#################################################################
#Made by Adventquest											#
#Use function to process the sell of golden_chestplate_134		#
#################################################################
...
execute if entity @s[scores={CHRONOTON=26..}] run function att2:items/armor/com/golden_chestplate_134
