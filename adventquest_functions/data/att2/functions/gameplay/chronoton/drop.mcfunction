...
execute as @s[scores={CHRONOTON_TODROP=500..}] at @s positioned ~ ~1 ~ run function att2:summon/chronoton/diamond_10
...
execute as @s[scores={CHRONOTON_TODROP=50..499}] at @s positioned ~ ~1 ~ run function att2:summon/chronoton/diamond
...
execute as @s[scores={CHRONOTON_TODROP=5..49}] at @s positioned ~ ~1 ~ run function att2:summon/chronoton/big
...
execute as @s[scores={CHRONOTON_TODROP=1..4}] at @s positioned ~ ~1 ~ run function att2:summon/chronoton/small
