...
summon minecraft:item 7665 190 7190 {Item:{id:"minecraft:ghast_tear",Count:1b,tag:{EquipmentType:"misc",Rarity:"que",display:{Name:"\"§cLarme céleste\"",Lore:["§4§oCelestial tear"]}}}}