...
tellraw @a[scores={LANGUAGE=0}] {"text":"°-° Phoebius : ","color":"green","extra":[{"text":"Si cela vous fait quitter notre village sans que vous ne causier de problème, je vous la donne. Mais vous devrez affronter Relgon, car ce sceau est sa propritété... Je ne vous souhaite pas bonne chance, car vous n'en aurez aucune.","color":"dark_aqua"}]}
