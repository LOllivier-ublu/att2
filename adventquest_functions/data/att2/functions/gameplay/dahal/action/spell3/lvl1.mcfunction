...
particle minecraft:item minecraft:blaze_powder ~ ~1 ~ 0 0 0 1 40 normal
particle minecraft:flame ~ ~1 ~ 0 0 0 1 40 normal
particle minecraft:dust 1 0.5 0 1.5 ~ ~1 ~ 0.1 0.1 0.1 0 10 normal
