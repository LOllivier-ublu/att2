...
execute if entity @s[scores={CHRONOTON=10000..}] if score @s SPELL20_LVL matches 2..3 run function att2:gameplay/shop/selling_items/spell/stock_upgrade_buying