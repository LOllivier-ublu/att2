...
execute positioned 5000 71 -4882 if score Pool4_A1 ARENA matches -2 if score Pool4_A1_Choose ARENA matches -1 run function att2:gameplay/arena/portal_between_arena_effect_go
