...
execute as @a at 00000000-0000-008b-0000-00000000008a run function att2:sound/misc/big_explosion
execute at 00000000-0000-008b-0000-00000000008a run particle minecraft:item minecraft:pink_stained_glass ~ ~ ~ 0.3 1 0.3 1 100 force @a
