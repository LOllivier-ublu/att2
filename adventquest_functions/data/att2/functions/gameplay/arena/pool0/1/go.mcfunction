...
#####################################################################
#/kill @e[distance=..15,tag=ArenaMinion]
# Music management
...
execute if score Pool0_A1 ARENA matches -1 if score Pool0_Timer1 ARENA matches 0 if entity @a[x=5123,y=69,z=-4774,dx=62,dy=53,dz=62,gamemode=adventure] run function att2:gameplay/arena/pool0/1/trigger_start
