...
execute if entity @s[scores={DIMENSION=1}] in minecraft:overworld positioned -6003 109 -4302 run function att2:gameplay/quest/mainquest/show_main_objective
execute if entity @s[scores={DIMENSION=0}] in minecraft:overworld positioned -7505 111 -4299 run function att2:gameplay/quest/mainquest/show_main_objective
