...
tellraw @s[scores={LANGUAGE=1}] {"text":" °-° Emerald : ","color":"green","extra":[{"text":"Indeed, her name is Sélène, but since her mother Tatiana died she took her nickname: ''Tina''. Sélène already didn't see her mother very much because of her job, so when she lost her at 7, she was inconsolable. She decided to follow in her footsteps from the age of 13. It must be said that I did not measure up... But now Sélène is 17 years old and I don't want to lose her like her mother. She is all I have left... Don't let me down.","color":"dark_aqua"}]}
