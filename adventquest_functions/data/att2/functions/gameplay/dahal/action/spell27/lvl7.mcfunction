...
give @s minecraft:diamond_axe{EquipmentType:"meleeWeapon",EquipmentID:"spectralaxe",Rarity:"epi",Manufacturer:"delightful",Unbreakable:1,display:{Name:"\"§5Hache spectrale\"",Lore:["§7Renforce la volonté de ton maître","§7pour 60 secondes.","§7Strengthen your master's will","§7for 60 seconds."]},Damage:1560,AttributeModifiers:[{AttributeName:generic.attackDamage,Name:generic.attackDamage,Amount:28.54,Operation:0,Slot:mainhand,UUIDLeast:10000,UUIDMost:10001},{AttributeName:generic.attackSpeed,Name:generic.attackSpeed,Amount:-0.78,Operation:1,Slot:mainhand,UUIDLeast:10000,UUIDMost:20001}]} 1
