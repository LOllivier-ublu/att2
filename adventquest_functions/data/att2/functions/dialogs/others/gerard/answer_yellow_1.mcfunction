...
tellraw @a[scores={LANGUAGE=0}] {"text":"°-° Gerard : ","color":"green","extra":[{"text":"Ah, bon j'avais un doute... Depuis que ce portail maléfique est apparu, la tranquilité de ce village en est complètement changée. Voyez-vous l'ancien proprétaire, maintenant partie, j'ai pris racine et payé cette maison au prix fort. J'aimerais donc finir les années qui me restent paisiblement ici.","color":"dark_aqua"}]}
