...
give @s minecraft:diamond_sword{EquipmentType:"meleeWeapon",Rarity:"rar",Manufacturer:"delightful",Effect:"spd2_luc1_dar_2",display:{Name:"\"§9Souvenir perdu\"","Lore":["{\"text\":\"§7Ô temps lointains, \"}","{\"text\":\"§7Ô insouciance juvénile.\"}","{\"text\":\"§7O distant times,\"}","{\"text\":\"§7O youthful recklessness.\"}","{\"text\":\"§7SPD§a2 §7LUC§a1 §7DAR§c-2\"}"]},Damage:1300,Enchantments:[{id:"minecraft:sweeping",lvl:1s}],AttributeModifiers:[{AttributeName:generic.attack_damage,Name:generic.attack_damage,Amount:8.19,Operation:0,Slot:mainhand,UUID:[I;0,10004,0,10000]},{AttributeName:generic.attack_speed,Name:generic.attack_speed,Amount:-0.6699999999999999,Operation:1,Slot:mainhand,UUID:[I;0,20004,0,10000]}]} 1