...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"There is a kind of cricuit protected by a security system. I should deactivate everything and then fly by going through this circuit to get out of the area.","color":"aqua","bold":false}]}