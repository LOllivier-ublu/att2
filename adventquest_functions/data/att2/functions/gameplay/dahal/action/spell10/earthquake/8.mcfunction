...
particle minecraft:item minecraft:iron_block ~ ~0.2 ~ 8 0.25 8 0.1 8 normal
particle minecraft:item minecraft:gray_concrete ~ ~0.2 ~ 8 0.25 8 0.1 8 normal
particle minecraft:item minecraft:dirt ~ ~0.2 ~ 8 0.25 8 0.1 8 normal
