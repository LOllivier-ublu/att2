...
# TP
execute as @a[x=-6004,y=108,z=-4277,dx=0,dy=1,dz=0,gamemode=adventure] at @s run function att2:cinematic/act_4/nojelanth/tp_present_to_past
...
# Particle
execute positioned -6004 109.0 -4277 run function att2:cinematic/act_4/nojelanth/tp_effect
