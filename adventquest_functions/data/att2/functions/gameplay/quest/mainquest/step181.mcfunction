...
execute in minecraft:overworld positioned -5006 149 -4880 run function att2:gameplay/gps/summon_arrow
execute in minecraft:overworld as @e[tag=newGPS] at @s anchored feet facing -5006 149 -4880 run function att2:gameplay/gps/tp_arrow
