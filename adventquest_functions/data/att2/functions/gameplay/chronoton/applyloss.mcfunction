...
execute if score level DIFFICULTY matches -1..0 run scoreboard players operation @s CHRONOTONquart /= 20 OP_CHRONOTON2
execute if score level DIFFICULTY matches 1 run scoreboard players operation @s CHRONOTONquart /= 10 OP_CHRONOTON2
