####################################	*#
#Spawner for att2:summon/reg_1/creeper4_class20	#
####################################	*#
...
execute positioned -7540 130 -4320 unless entity @e[team=hostile,distance=..30,scores={COUNT=5..}] run function att2:summon/reg_1/creeper4_class20
