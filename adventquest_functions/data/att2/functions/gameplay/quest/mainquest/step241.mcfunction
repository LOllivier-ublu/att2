...
execute in minecraft:overworld positioned -7414 165 -5975 run function att2:gameplay/gps/summon_arrow
execute in minecraft:overworld as @e[tag=newGPS] at @s anchored feet facing -7414 165 -5975 run function att2:gameplay/gps/tp_arrow
