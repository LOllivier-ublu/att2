...
execute as @e[x=-7536,y=78,z=-4163,dx=-21,dy=-10,dz=-24,type=minecraft:bee,tag=hive] at @s run tp @s ~ 0 ~
kill @e[x=-7536,y=78,z=-4163,dx=-21,dy=-10,dz=-24,type=minecraft:bee,tag=hive]
