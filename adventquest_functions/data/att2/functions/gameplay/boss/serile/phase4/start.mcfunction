...
execute as 00000000-0000-022b-0000-00000000022b run data merge entity @s {Invulnerable:1,Glowing:1,NoAI:0,Attributes:[{Name:generic.attackDamage,Base:30.0},{name:generic.movementSpeed,Base:0.32},{Name:generic.followRange,Base:100.0},{Name:generic.knockbackResistance,Base:1.0}]}
