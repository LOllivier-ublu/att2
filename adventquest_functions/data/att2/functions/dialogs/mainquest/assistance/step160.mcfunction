...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"Voilà, je peux continuer de grimper dans la tour sud-est. Il va falloir encore activer quelques mécanismes...","color":"aqua","bold":false}]}
