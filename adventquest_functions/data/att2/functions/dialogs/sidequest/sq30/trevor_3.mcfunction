...
tellraw @a[scores={LANGUAGE=0}] {"text":"°-° Commandant Trevor : ","color":"green","extra":[{"text":"Non attendez ! Je vous prie de ne rien dire au roi sur ce que vous venez de voir ! Car si telle est votre intention, je préfère encore vous occire sur le champ qu'affronter le couroux de mon roi !","color":"dark_aqua"}]}
