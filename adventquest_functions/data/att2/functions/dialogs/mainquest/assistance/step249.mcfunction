...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"I have to search to reach the upper floors. There must be mechanisms opening doors in the temporality where everything seems intact.","color":"aqua","bold":false}]}