...
execute if score Timer1 UMBRATYANTH matches 10.. if entity @e[nbt={UUIDMost:300L,UUIDLeast:300L,AbsorptionAmount:0.0f}] as @p[x=-5117,y=121,z=-6870] run function att2:gameplay/boss/ether/umbratyanth/phase2/choose_pos
