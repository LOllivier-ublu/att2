...
tellraw @a[scores={LANGUAGE=0}] {"text":"[ -->]","color":"green","clickEvent":{"action":"run_command","value":"/execute if score Mainquest SIDEQUEST matches 288 if score Neth0 TIMER matches ..8199 run scoreboard players set Neth0 TIMER 8200"},"hoverEvent":{"action":"show_text","value":"Passer les crédits..."}}
