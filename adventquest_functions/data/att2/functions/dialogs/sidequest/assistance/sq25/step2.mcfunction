...
tellraw @s[scores={LANGUAGE=0}] {"text":"-°- Le périple d'Emerald -°- : ","color":"gray","extra":[{"text":"J'ai trouvé la ","color":"aqua","italic":true,"extra":[{"text":"<Veste de Tina>","color":"red","hoverEvent":{"action":"show_item","value":"{\"id\":\"minecraft:leather_chestplate\",\"Count\":1,\"tag\":{\"display\":{\"Enchantments\":[{\"id\":\"minecraft:protection\",\"lvl\":3}],Unbreakable:1b,Name:\"{\\\"text\\\":\\\"Vest de Tina\\\"}\",\"Lore\":[\"{\\\"text\\\":\\\"Tina's Jacket\\\"}\"]}}}"},"extra":[{"text":". C'est une preuve suffisant qu'elle est toujours en vie et dans la région. Je vais rapporter la veste à Emerald, il sera sans doute soulagé d'avoir une piste aussi fraîche.","color":"aqua","italic":true}]}]}]}
