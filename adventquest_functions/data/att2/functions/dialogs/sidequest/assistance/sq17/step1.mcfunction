...
tellraw @s[scores={LANGUAGE=2}] {"text":"-°- 至關重要的緊急情況 -°- : ","color":"gray","extra":[{"text":" ","color":"aqua","italic":true,"extra":[{"text":"<Bandages>","color":"red","hoverEvent":{"action":"show_item","value":"{\"id\":\"minecraft:dye\",\"Count\":1,\"tag\":{\"display\":{\"Name\":\"{\\\"text\\\":\\\"Bandages\\\"}\",\"Lore\":[\"{\\\"text\\\":\\\"Bandages\\\"}\"]}}}"},"extra":[{"text":" ","color":"aqua","italic":true}]}]}]}