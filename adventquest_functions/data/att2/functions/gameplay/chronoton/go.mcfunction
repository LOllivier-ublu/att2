...
scoreboard players set @a[nbt={Inventory:[{id:"minecraft:gold_nugget",tag:{display:{Name:"{\"text\":\"§e§oPetite pièce\"}",Lore:["§e§oSmall coin","§6+1 Chronoton"]}}}]}] CHRONOTONbis 1
execute as @a[scores={CHRONOTONbis=1}] run function att2:gameplay/chronoton/convertnugget

scoreboard players set @a[nbt={Inventory:[{id:"minecraft:gold_ingot",tag:{display:{Name:"{\"text\":\"§e§oGrande pièce\"}",Lore:["§e§oBig coin","§6+5 Chronotons"]}}}]}] CHRONOTONbis 5
execute as @a[scores={CHRONOTONbis=5}] run function att2:gameplay/chronoton/convertingot

scoreboard players set @a[nbt={Inventory:[{id:"minecraft:diamond",tag:{display:{Name:"{\"text\":\"§b§oDiamant\"}",Lore:["§b§oDiamond","§6+50 Chronotons"]}}}]}] CHRONOTONbis 50
