...
execute positioned -5276.1 53.5 -4674.0 run summon minecraft:wolf ~ ~ ~ {Rotation:[90.0f,0.0f],Silent:1,NoAI:1,Invulnerable:1,Silent:1,PersistenceRequired:1,Attributes:[{Name:generic.attack_damage,Base:0.0}],ActiveEffects:[{Id:14,Amplifier:1,Duration:2147483647,Ambient:1,ShowParticles:0}],Passengers:[{id:"minecraft:zombified_piglin",Rotation:[90.0f,0.0f],NoAI:1,Invulnerable:1,CustomName:"\"BRYNHILD\"",Silent:1,PersistenceRequired:1,Attributes:[{Name:generic.attack_damage,Base:0.0},{Name:generic.max_health,Base:1.0}],Health:1,ArmorItems:[{id:"minecraft:chainmail_boots",Count:1},{id:"minecraft:chainmail_leggings",Count:1},{id:"minecraft:diamond_chestplate",Count:1},{id:"minecraft:player_head",Count:1,tag:{SkullOwner:{Id:[I;2063081282,597246935,-1705969466,-2043547480],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOWJiNzg2NjgxZjdiNDNhNzRiZjAxYjRlY2UyODgxNjU3ZWY3NmI5MzU5MjQ4OWE5MWQyZmI0NWUxYTI4MTcifX19"}]}}}}]}]}