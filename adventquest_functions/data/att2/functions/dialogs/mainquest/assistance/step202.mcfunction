...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Je dois retourner parler à Skaolon devant la porte du palais d'Ouranos. Avec ce Néleptron, il va peut-être m'accorder la permission d'obtenir une audience auprès du roi.","color":"aqua","bold":false}]}
