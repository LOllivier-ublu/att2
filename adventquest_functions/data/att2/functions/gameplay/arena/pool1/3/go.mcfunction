...
# Music management
execute if score Pool1_A3 ARENA matches 0.. as @a[x=5203,y=70,z=-5035,dx=78,dy=29,dz=70,scores={MUSIC_BOSS=0}] at @s run function att2:gameplay/boss/music_sideboss
