...
tellraw @a[scores={LANGUAGE=0}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"*surpis* L'élève est étrange aujourd'hui, l'air de ce monde le rend peut-être malade ?","color":"dark_aqua"}]}
