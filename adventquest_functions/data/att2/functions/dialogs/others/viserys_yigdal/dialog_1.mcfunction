...
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Viserys Yigdal : ","color":"green","extra":[{"text":"","color":"dark_aqua","extra":[{"text":" [看商品 -->]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/shop/seller/viserys_yigdal_shop_opening"},"hoverEvent":{"action":"show_text","value":"單擊此處查看 Viserys 的銷售情況。"}}]}]}