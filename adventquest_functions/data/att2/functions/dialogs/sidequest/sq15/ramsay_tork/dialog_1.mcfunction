#################################################################
#Made by Adventquest											#
#Use function to process the Dialog 1 of Ramsay Tork 			#
#################################################################
...
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Ramsay Tork : ","color":"green","extra":[{"text":"你好，但多麼有趣的服裝啊！我們缺少黃金來打造最高品質的盔甲！我知道在哪裡可以找到它：在安戈爾廢墟的大型機庫和鑄造廠裡，有這種未使用的黃金。如果你給我帶來很多，我會為你鍛造出色的盔甲。","color":"dark_aqua"}]}
