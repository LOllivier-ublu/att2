...
execute as @e[nbt={UUID:[I;0,363,0,27]}] at @s run tp @s ~ 0 ~
kill @e[nbt={UUID:[I;0,363,0,27]}]
execute as @e[nbt={UUID:[I;0,363,0,43]}] at @s run tp @s ~ 0 ~
kill @e[nbt={UUID:[I;0,363,0,43]}]
execute as @e[nbt={UUID:[I;0,363,0,59]}] at @s run tp @s ~ 0 ~
kill @e[nbt={UUID:[I;0,363,0,59]}]
execute as @e[nbt={UUID:[I;0,363,0,75]}] at @s run tp @s ~ 0 ~
