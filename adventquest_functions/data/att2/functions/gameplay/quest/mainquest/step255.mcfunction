...
execute if entity @s[scores={DIMENSION=1}] in minecraft:overworld positioned -6000 161 -4272 run function att2:gameplay/gps/summon_arrow
execute if entity @s[scores={DIMENSION=1}] in minecraft:overworld as @e[tag=newGPS] at @s anchored feet facing -6000 161 -4272 run function att2:gameplay/gps/tp_arrow
