...
scoreboard players set Chrono_Beat NIGHTMARERUN 0
...
scoreboard players set Chrono_Second_Gold NIGHTMARERUN 0
scoreboard players set Chrono_Minute_Gold NIGHTMARERUN 20
scoreboard players set Chrono_Hour_Gold NIGHTMARERUN 0

scoreboard players set Chrono_Beat_Silver NIGHTMARERUN 0
scoreboard players set Chrono_Second_Silver NIGHTMARERUN 0
scoreboard players set Chrono_Minute_Silver NIGHTMARERUN 25
