...
execute if score FlammeNoire ANGOR_BOSS matches 200 as @e[type=minecraft:zombie_pigman,nbt={UUIDMost:91L,UUIDLeast:123L}] at @s run teleport @s 3517.3 71.6 4943 165 30
execute if score FlammeNoire ANGOR_BOSS matches 200 as @e[type=minecraft:zombie_pigman,nbt={UUIDMost:91L,UUIDLeast:139L}] at @s run teleport @s 3510.7 71.6 4943 165 30
...
execute if score FlammeNoire ANGOR_BOSS matches 50 as @e[type=minecraft:zombie_pigman,nbt={UUIDMost:91L,UUIDLeast:123L}] at @s run teleport @s 3517.3 46.6 4933 165 0
execute if score FlammeNoire ANGOR_BOSS matches 50 as @e[type=minecraft:zombie_pigman,nbt={UUIDMost:91L,UUIDLeast:139L}] at @s run teleport @s 3510.3 46.6 4933 165 0
