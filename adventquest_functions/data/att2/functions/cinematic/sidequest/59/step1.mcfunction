...
execute positioned -5030 79 -5035 as @e[type=minecraft:zombified_piglin,distance=..2] at @s run function att2:cinematic/sidequest/59/step1/earndhel_guard/move_pnj
