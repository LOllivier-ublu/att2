...
execute if score Dash EARNDHEL matches 2 run data merge entity 00000000-0000-008b-0000-00000000008a {AngerTime:1000000,Attributes:[{Name:generic.movement_speed,Base:0.2},{Name:generic.follow_range,Base:0.0}]}
execute if score Dash EARNDHEL matches 1..10 if score Etotsira EARNDHEL matches 1 at 00000000-0000-008b-0000-00000000008a as @a[distance=..4] run effect give @s minecraft:instant_damage 1 2 true
...
execute if score Dash EARNDHEL matches 0 run data merge entity 00000000-0000-008b-0000-00000000008a {Attributes:[{Name:generic.follow_range,Base:30.0}]}
