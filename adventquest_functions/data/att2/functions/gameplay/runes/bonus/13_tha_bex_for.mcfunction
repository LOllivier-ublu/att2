...
execute if score 13_tha_bex_for RUNE matches 1 run scoreboard players add BonusDahalMax RUNE 2
execute if score 13_tha_bex_for RUNE matches 1 run scoreboard players add BonusCooldown RUNE 1
