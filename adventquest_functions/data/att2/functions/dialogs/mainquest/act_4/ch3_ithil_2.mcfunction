...
tellraw @a[scores={LANGUAGE=0}] {"text":" °-° Ithil : ","color":"green","extra":[{"text":"J'en doute... La suprise que Père vous a témoignée lors de votre rencontre suite à l'ouverture du portail de Ryliath, ne vous aura pas échappé. Elle était fausse : Père est bon acteur... Des portails nous en avons toujours eu à Ryliath, même avant que vous ne veniez. Bref, s'il vous faut des gemmes de temps, il va vous falloir changer de royaume. Autant que je vous montre ça de suite, si tant est que vous ne vous soyez pas dégonflé...","color":"dark_aqua"}]}
