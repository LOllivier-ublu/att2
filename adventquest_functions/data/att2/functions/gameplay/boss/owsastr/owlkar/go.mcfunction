...
execute if score Owlkar OWSASTR matches -2 unless entity @a[x=-5073,y=71,z=-4404,dx=46,dy=7,dz=46,gamemode=adventure,tag=!Dead] unless score Mainquest SIDEQUEST matches 26..29 run function att2:gameplay/boss/owsastr/owlkar/reinitialize