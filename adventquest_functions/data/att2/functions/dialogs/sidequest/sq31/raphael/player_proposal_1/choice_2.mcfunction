...
tellraw @s[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[來吧， 我把我的馬託付給你。有了這個， 您將能夠快速到達一個城市並找到貨物的解決方案。-->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-093a-0000-00000000093a if entity @a[distance=..7] if score raphael_PNJ DIALOG matches 3 run function att2:cinematic/sidequest/31/raphael/horse_trigger_2"},"hoverEvent":{"action":"show_text","value":"點擊這裡 - 回答 2"}}]}