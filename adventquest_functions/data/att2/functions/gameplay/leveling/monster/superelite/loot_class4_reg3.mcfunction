...
function att2:summon/bat_superelite4_reg3_rewards
function att2:summon/bat_superelite4_reg3_rewards
execute if score level DIFFICULTY matches 0.. run function att2:summon/bat_superelite4_reg3_rewards
execute if score level DIFFICULTY matches 1.. run function att2:summon/bat_superelite4_reg3_rewards
execute if score level DIFFICULTY matches 2.. run function att2:summon/bat_superelite4_reg3_rewards
