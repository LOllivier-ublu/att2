...
# Music management
execute if score Miehanov VONAHEIM matches 0.. as @a[x=-5641,y=173,z=-6342,dx=52,dy=-8,dz=-51,scores={MUSIC_BOSS=0}] at @s run function att2:gameplay/boss/music_demiboss
...
execute if score Miehanov VONAHEIM matches -1 if entity @a[x=-5641,y=173,z=-6342,dx=52,dy=-8,dz=-51,gamemode=adventure] run function att2:gameplay/boss/elcheol/miehanov/start

# Process action of Miehanov
execute if score Miehanov VONAHEIM matches 0 if entity @a[x=-5641,y=173,z=-6342,dx=52,dy=-8,dz=-51,gamemode=adventure] run function att2:gameplay/boss/elcheol/miehanov/action

# Process effect and particle of Miehanov
execute if score Miehanov VONAHEIM matches 0 as @a[x=-5641,y=173,z=-6342,dx=52,dy=-8,dz=-51,gamemode=adventure] run effect clear @s minecraft:blindness
...
execute if score Miehanov VONAHEIM matches -2 unless entity @a[x=-5641,y=173,z=-6342,dx=52,dy=-8,dz=-51,gamemode=adventure,tag=!Dead] unless score Mainquest SIDEQUEST matches 113..116 run function att2:gameplay/boss/elcheol/miehanov/initialize