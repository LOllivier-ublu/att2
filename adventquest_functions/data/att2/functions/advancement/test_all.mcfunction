...
execute as @a[gamemode=adventure] at @s if score @s openSHULKER matches 1.. run function att2:advancement/add_chest_score
...
execute as @a[gamemode=adventure] at @s if score @s triggCHEST matches 1.. run function att2:advancement/test_all/secret/shulker_test
