...
execute as @e[x=4734,y=70,z=-4965,dx=75,dy=56,dz=-71,tag=Shadow,limit=1] if entity @s[nbt={AbsorptionAmount:0.0f}] run data merge entity @s {AbsorptionAmount:30.0f}
