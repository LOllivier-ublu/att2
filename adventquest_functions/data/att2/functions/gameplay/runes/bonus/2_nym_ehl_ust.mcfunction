...
execute if entity @p[scores={GAMELEVEL=20..}] run scoreboard players add 2_nym_ehl_ust RUNE 1
...
execute if score 2_nym_ehl_ust RUNE matches 1 run scoreboard players add BonusLootBoss RUNE 1
