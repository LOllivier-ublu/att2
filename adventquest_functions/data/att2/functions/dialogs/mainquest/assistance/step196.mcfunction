...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"The path is still blocked by a sort of energy gate. There are these kinds of hoops levitating on the way, maybe by going inside I will activate the opening of the door.","color":"aqua","bold":false}]}