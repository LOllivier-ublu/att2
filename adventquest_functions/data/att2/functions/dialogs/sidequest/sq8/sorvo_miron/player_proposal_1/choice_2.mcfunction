...
tellraw @s[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[你最烈的酒是什麼？ -->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-044a-0000-00000000044a if entity @s[distance=..7] if score sorvo_miron_PNJ DIALOG matches 1 run function att2:cinematic/sidequest/8/sorvo_miron/chronoton_trigger_2"},"hoverEvent":{"action":"show_text","value":"點擊這裡 - 回答 2"}}]}