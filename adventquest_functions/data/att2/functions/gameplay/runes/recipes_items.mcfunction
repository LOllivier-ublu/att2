...
# 2 Loot Runes ABC
execute if block ~ ~ ~ minecraft:hopper{Items:[{id:"minecraft:quartz",Count:1b,Slot:0b,tag:{EquipmentType:"misc",Rarity:"unk"}},{id:"minecraft:quartz",Count:1b,Slot:1b,tag:{EquipmentType:"misc",Rarity:"unk"}}]} run function att2:summon/bat_runes_abc_rewards_1
# 3 Loot Runes ABC
