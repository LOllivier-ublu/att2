...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"Here I am in the other wing of the academy. There has to be a way to climb higher in the time frame where the systems work. Some sort of security mechanism with colors can be activated.","color":"aqua","bold":false}]}