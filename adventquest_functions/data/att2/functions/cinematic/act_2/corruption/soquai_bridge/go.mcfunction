...
execute if score Real2 TIMER matches 60..100 as @a[x=-4724,y=72,z=-5826,dx=16,dy=10,dz=10] at @s run tp @s ~ ~ ~ facing entity @e[nbt={UUIDLeast:4426L,UUIDMost:4426L},limit=1]
...
execute if score Real2 TIMER matches 152 if entity @a[x=-4724,y=72,z=-5826,dx=16,dy=10,dz=10] unless entity @e[x=-4724,y=72,z=-5826,dx=16,dy=10,dz=10,nbt={UUIDLeast:4426L,UUIDMost:4426L}] run function att2:cinematic/act_2/corruption/soquai_bridge/action_3
