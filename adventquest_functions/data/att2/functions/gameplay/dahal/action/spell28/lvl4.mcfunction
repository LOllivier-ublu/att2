...
give @s minecraft:bow{EquipmentType:"rangeWeapon",Rarity:"unc",EquipmentID:"spectralbow",Manufacturer:"traditional",Unbreakable:1,display:{Name:"\"§2Arc spectral\"",Lore:["§7Etends l'influence de ton maître","§7pour 45 secondes.","§7Extend your master's influence","§7for 45 seconds."]},Damage:382,Enchantments:[{id:"minecraft:power",lvl:4s},{id:"minecraft:infinity",lvl:1s}]} 1
