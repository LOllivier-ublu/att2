...
execute if entity @s[scores={DIMENSION=0}] in minecraft:overworld positioned -7509 150 -4292 run function att2:gameplay/gps/summon_arrow
execute if entity @s[scores={DIMENSION=0}] in minecraft:overworld as @e[tag=newGPS] at @s anchored feet facing -7509 150 -4292 run function att2:gameplay/gps/tp_arrow
