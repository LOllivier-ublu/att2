#################################################################
#Made by Adventquest											#
#Use function to process the sell of leather_chestplate_7		#
#################################################################
...
execute if entity @s[scores={CHRONOTON=54..}] run function att2:items/armor/unc/leather_chestplate_7
