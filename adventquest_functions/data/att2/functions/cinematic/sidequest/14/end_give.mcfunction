...
clear @a minecraft:brick{display:{Lore:["§4Derim Key"]}}
...
execute if score choice SQ14 matches 1 run scoreboard players add @a CHRONOTON 200
execute if score choice SQ14 matches 1 run tellraw @a {"text":"* ","color":"dark_red","extra":[{"text":"+200 Chronotons","color":"gray","italic":true},{"text":" *","color":"dark_red"}]}
