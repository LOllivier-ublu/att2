...
particle minecraft:flame ~ ~ ~ 0 0 0 0 2 normal
...
execute as @e[distance=..1.5,scores={GAMELEVEL=0..},team=hostile,tag=!Undead] run effect give @s minecraft:instant_damage 2 1
execute as @e[distance=..1.5,scores={GAMELEVEL=0..},team=hostile,tag=Undead] run effect give @s minecraft:instant_health 2 1
