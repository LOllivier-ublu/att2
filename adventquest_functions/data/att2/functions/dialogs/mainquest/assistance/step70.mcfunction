...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"I arrived at the top of the palace fortifications but the doors to the upper levels are closed. I should try to go to a lower wing, maybe I'll find a passage there, or a big key.","color":"aqua","bold":false}]}