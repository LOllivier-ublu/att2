...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"Wirth? Is that it? Let me introduce myself, I am ","color":"aqua"},{"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"aqua"},{"text":". Yaakov sent me to you so I could gather some information. I'm looking for Gems of Space.","color":"aqua"}]}
