...
execute if entity @s[scores={DIMENSION=0}] in minecraft:overworld positioned -7500 141 -4273 run function att2:gameplay/gps/summon_arrow
execute if entity @s[scores={DIMENSION=0}] in minecraft:overworld as @e[tag=newGPS] at @s anchored feet facing -7500 141 -4273 run function att2:gameplay/gps/tp_arrow
