...
execute as @e[x=5203,y=70,z=-5035,dx=78,dy=29,dz=70,tag=Vonaheim,limit=1] if entity @s[nbt={AbsorptionAmount:0.0f}] run data merge entity @s {AbsorptionAmount:30.0f}
execute as @e[x=5203,y=70,z=-5035,dx=78,dy=29,dz=70,tag=Miehanov,limit=1] if entity @s[nbt={AbsorptionAmount:0.0f}] run data merge entity @s {AbsorptionAmount:30.0f}
execute as @e[x=5203,y=70,z=-5035,dx=78,dy=29,dz=70,tag=Ted,limit=1] if entity @s[nbt={AbsorptionAmount:0.0f}] run data merge entity @s {AbsorptionAmount:30.0f}