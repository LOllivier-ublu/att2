#################################################################
#Made by Adventquest											#
#Use function to process the Dialog 1 of Warren 				#
#################################################################


#FRENCH LANGUAGE

tellraw @s[scores={LANGUAGE=0}] {"text":" °-° Warren : ","color":"green","extra":[{"text":"C'est mon jour de chance, pouvez-vous m'aider ? Je suis marchand et je prends souvent ce raccourci sous les montagnes pour livrer ma marchandise en ville. J'ai pris le risque de traverser malgré l'activité du volcan. Malheureusement, il y eut des tremblements puis des éboulements et j'ai perdu mon chargement en fuyant pour sauver ma peau.","color":"dark_aqua"}]}
...
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Warren : ","color":"green","extra":[{"text":"","color":"dark_aqua"}]}
