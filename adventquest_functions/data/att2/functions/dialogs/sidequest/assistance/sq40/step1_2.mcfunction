...
tellraw @s[scores={LANGUAGE=0}] {"text":"-°- Parfois, il n'y a juste pas assez de pierres -°- : ","color":"gray","extra":[{"text":"Babbu m'a donné une carte. Elle indique un lieu précis noté d'une croix au sud de la région. Je dois allez voir ce qui se trouve caché là-bas.","color":"aqua","italic":true}]}
