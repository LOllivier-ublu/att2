...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"I have to find an emerald key, but for that I have to activate a mechanism and I need three gears. They must be in the room itself.","color":"aqua","bold":false}]}