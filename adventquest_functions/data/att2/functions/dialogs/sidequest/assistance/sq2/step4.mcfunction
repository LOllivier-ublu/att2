...
tellraw @s[scores={LANGUAGE=2}] {"text":"-°- 缺鐵的鐵匠 -°- : ","color":"gray","extra":[{"text":" ","color":"aqua","italic":true,"bold":false,"extra":[{"text":"<Iron ingot>","color":"red","hoverEvent":{"action":"show_item","value":"{\"id\":\"minecraft:iron_ingot\",\"Count\":1,\"tag\":{\"display\":{\"Name\":\"{\\\"text\\\":\\\"Lingot de Fer\\\"}\",\"Lore\":[\"{\\\"text\\\":\\\"Iron Ingot\\\"}\"]}}}"},"extra":[{"text":" ","bold":false,"color":"aqua","italic":true}]}]}]}