...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"Just curious, how do you intend to make the disrespectfuls pay?","color":"aqua"}]}
...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"*in a hushed voice* What a fucker... But his intentions are really concerning...","color":"aqua"}]}