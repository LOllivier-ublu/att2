...
execute as 00000000-0000-129a-0000-00000000129a at @s run data merge entity @s {HandItems:[{id:"minecraft:bow",Count:1b,tag:{Damage:383,display:{Enchantments:[{id:"minecraft:fire_aspect",lvl:2}]}}},{}]}