...
tellraw @s[scores={LANGUAGE=0}] {"text":"°-° Berni Dalph : ","color":"green","extra":[{"text":"Non monsieur, l'accés aux égouts est strictement interdit, par ordre du roi...","color":"dark_aqua"}]}
