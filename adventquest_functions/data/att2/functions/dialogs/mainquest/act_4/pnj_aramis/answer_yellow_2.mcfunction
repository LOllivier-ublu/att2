...
tellraw @a[scores={LANGUAGE=0}] {"text":"°-° Aramis : ","color":"green","extra":[{"text":"Je sais qui vous êtes... Je ne suis pas aussi généreux qu'Etotsira, voyez-vous. Notre ville à faim, alors si vous êtes disposé à nous aider, je ferai aussi un effort.","color":"dark_aqua"}]}
