...
execute if score babbu_timer SQ39 matches 0..288000 run scoreboard players add babbu_timer SQ39 1
...
execute if score babbu_timer SQ39 matches 288000.. if score move_babbu SQ39 matches 1 run function att2:cinematic/sidequest/39/step2
