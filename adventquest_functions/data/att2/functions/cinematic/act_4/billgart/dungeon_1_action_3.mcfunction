...
summon minecraft:armor_stand -1238.1 27.5 -615.1 {Rotation:[0.0f,0.0f],HandItems:[{id:"minecraft:clay_ball",Count:1,tag:{Enchantments:[{id:"minecraft:infinity",lvl:1}],display:{Name:"\"§6Gemme de Temps\"",Lore:["§4§oGem of Time"]}}},{}],ShowArms:1,Invisible:1,NoGravity:1,DisabledSlots:2039326,Pose:{RightArm:[-90f,0f,0f]}}
