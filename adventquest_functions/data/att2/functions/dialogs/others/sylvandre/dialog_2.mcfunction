...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@s","color":"gray","extra":[{"text":" : "},{"text":"Tu tombes toujours à pic toi !","color":"aqua"}]}
...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@s","color":"gray","extra":[{"text":" : "},{"text":"You always come at the right time don't you!","color":"aqua"}]}
