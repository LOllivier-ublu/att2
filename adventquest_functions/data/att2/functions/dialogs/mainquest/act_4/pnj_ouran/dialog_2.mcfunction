...
execute as @a[x=7954,y=120,z=6792,distance=..30] run function att2:dialogs/mainquest/act_4/pnj_ouran/player_answer_proposal_4
execute as @a[x=7954,y=120,z=6792,distance=..30] run function att2:dialogs/mainquest/act_4/pnj_ouran/player_answer_proposal_5