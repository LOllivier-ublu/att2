...
tellraw @a[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"Here is a piece of paper: ''Of all the words which can be pronunced, those of regrets are mostly stated on the simpliest of papers.'' I bet it's the one J'zargo is looking for. It's time to clarify his intentions...","color":"aqua"}]}