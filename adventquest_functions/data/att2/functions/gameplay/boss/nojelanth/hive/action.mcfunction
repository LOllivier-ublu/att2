...
# Timer
execute if score Hive_timer1 SQ58 matches 1000 run function att2:gameplay/boss/nojelanth/hive/summoning_minion

# Iteration
execute if score Hive_timer1 SQ58 matches 1000.. run scoreboard players set Hive_timer1 SQ58 0
