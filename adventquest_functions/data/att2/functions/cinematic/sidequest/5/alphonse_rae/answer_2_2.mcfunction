...
execute as @e[type=minecraft:zombified_piglin,x=-3855,y=87,z=-6042,distance=..3] run data merge entity @s {Tags:["LVL0","CLASS4","Reg1","Undead"],AngerTime:1000000,NoAI:0,Invulnerable:0,AbsorptionAmount:0,HandItems:[{id:"minecraft:iron_shovel",Count:1},{}]}
