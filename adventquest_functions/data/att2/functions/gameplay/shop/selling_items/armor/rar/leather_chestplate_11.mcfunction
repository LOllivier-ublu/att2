#################################################################
#Made by Adventquest											#
#Use function to process the sell of leather_chestplate_11		#
#################################################################
...
execute if entity @s[scores={CHRONOTON=162..}] run function att2:items/armor/rar/leather_chestplate_11
