...
# Cinematic 2 - Step 19
execute if score SQ59 SIDEQUEST matches 19 if score step_19 SQ59 matches 1 if score cinematic_timer SQ59 matches 1.. run function att2:cinematic/sidequest/59/step19/cinematic2
