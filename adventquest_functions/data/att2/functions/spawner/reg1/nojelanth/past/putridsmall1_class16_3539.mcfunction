####################################	*#
#Spawner for att2:summon/reg_1/putridsmall1_class16	#
####################################	*#
...
execute positioned -7366 105 -4435 unless entity @e[team=hostile,distance=..20,scores={COUNT=3..}] run function att2:summon/reg_1/putridsmall1_class16
