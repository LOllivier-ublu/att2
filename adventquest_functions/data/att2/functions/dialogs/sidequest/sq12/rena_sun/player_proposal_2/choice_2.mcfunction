...
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° : ","color":"dark_gray","extra":[{"text":" [].","color":"gray","clickEvent":{"action":"run_command","value":"/scoreboard players set choice SQ12 2"},"hoverEvent":{"action":"show_text","value":"點擊這裡 - 回答 2"}}]}