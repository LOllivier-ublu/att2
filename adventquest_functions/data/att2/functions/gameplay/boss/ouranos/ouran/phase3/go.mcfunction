...
execute if score OuranPhase3 OURANOS matches 0.. store result bossbar minecraft:ouran max run data get entity 00000000-0000-017b-0000-00000000017b Attributes[0].Base
...
execute if score OuranPhase3 OURANOS matches 0.. as @e[type=minecraft:ender_dragon,nbt={UUIDMost:379L,UUIDLeast:379L,DragonPhase:3}] run data merge entity @s {DragonPhase:0}
