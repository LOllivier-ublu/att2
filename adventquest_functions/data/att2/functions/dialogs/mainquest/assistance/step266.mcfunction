...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"It gets worse and worse, but I disabled other doors to the floor.","color":"aqua","bold":false}]}