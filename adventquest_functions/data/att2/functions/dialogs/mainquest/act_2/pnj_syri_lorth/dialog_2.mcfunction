...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"Vous êtes Syri, n'est-ce pas ? Votre mère m'a conseillé de venir vous voir, j'aurais un service à vous demander...","color":"aqua"}]}
...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"You are Syri, aren't you? Your mother advised me to come and see you, I would like to ask you a favor...","color":"aqua"}]}
