...
execute if score SQ52 SIDEQUEST matches 3 if score cinematic SQ52 matches 6 at 00000000-0000-089a-0000-00000000089a if entity @a[distance=..5,gamemode=adventure,nbt={Inventory:[{id:"minecraft:ghast_tear",Count:1b,tag:{display:{Lore:["§4§oTear of the lost"]}}}]}] run function att2:cinematic/sidequest/52/jzargo/start_cinematic4
...
execute if score SQ52 SIDEQUEST matches 2 if entity @a[x=-5519.5,y=27.5,z=-4190.0,distance=..10,gamemode=adventure,nbt={Inventory:[{id:"minecraft:ghast_tear",Count:1b,tag:{display:{Lore:["§4§oTear of the lost"]}}}]}] run function att2:cinematic/sidequest/52/end
