...
tellraw @s[scores={LANGUAGE=2}] {"text":" ","color":"gray","italic":true,"extra":[{"text":"<resource-pack official of Across the Time 2 - Time For Regrets>.","color":"blue","italic":false,"clickEvent":{"action":"open_url","value":"https://adventquest.com/across-the-time-ii-time-for-regrets/resource-pack"},"hoverEvent":{"action":"show_text","value":"Download"}},{"text":" ","color":"gray","italic":true}]}