...
execute if score SQ45 SIDEQUEST matches 1 if entity @a[gamemode=adventure,nbt={Inventory:[{tag:{display:{Lore:["§4§oBadge"]}}}]}] run function att2:cinematic/sidequest/45/step2

# Step3 when player are in front of sectarian door with badge
execute if score SQ45 SIDEQUEST matches 2 if entity @a[x=3743,y=61,z=4338,distance=..4,gamemode=adventure,nbt={Inventory:[{tag:{display:{Lore:["§4§oBadge"]}}}]}] run function att2:cinematic/sidequest/45/step3

# Step4 when player found Nekr al Felèvsil 
execute if score SQ45 SIDEQUEST matches 1..3 if entity @a[gamemode=adventure,nbt={Inventory:[{tag:{display:{Lore:["§7Les bêtes Sécariennes ont jadis","§7craint tes griffes autant que ton nom.","§7The Secarian beasts once feared","§7your claws as much as your name.","§7STR§a2 §7HAS§a4"]}}}]}] run function att2:cinematic/sidequest/45/step4

# Start cinematic when player is close to Aldelrion with Nekr al Felèvsil 
execute if score SQ45 SIDEQUEST matches 4 if score cinematic SQ45 matches 2 at 00000000-0000-149a-0000-00000000149a if entity @a[distance=..5,gamemode=adventure,nbt={Inventory:[{tag:{display:{Lore:["§7Les bêtes Sécariennes ont jadis","§7craint tes griffes autant que ton nom.","§7The Secarian beasts once feared","§7your claws as much as your name.","§7STR§a2 §7HAS§a4"]}}}]}] run function att2:cinematic/sidequest/45/aldelrion/start_cinematic2
