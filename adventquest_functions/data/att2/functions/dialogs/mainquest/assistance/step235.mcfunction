...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"There is surely a mechanism activating the opening of the chest in the center of the room. I have to find one and unlock the accesses to the different rooms.","color":"aqua","bold":false}]}