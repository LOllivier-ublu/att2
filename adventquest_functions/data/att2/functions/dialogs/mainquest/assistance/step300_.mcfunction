...
tellraw @s[scores={LANGUAGE=0}] {"text":"-<°>- Quêtes secondaires terminées : ","color":"gray","extra":[{"score":{"name":"@s","objective":"SIDEQUEST"},"color":"red"},{"text":" / ","color":"grey"},{"text":"60","color":"dark_green"}]}
...
tellraw @s[scores={LANGUAGE=1}] {"text":"-<°>- Side quests completed : ","color":"gray","extra":[{"score":{"name":"@s","objective":"SIDEQUEST"},"color":"red"},{"text":" / ","color":"grey"},{"text":"60","color":"dark_green"}]}
