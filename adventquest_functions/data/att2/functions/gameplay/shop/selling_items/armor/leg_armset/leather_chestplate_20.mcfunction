#################################################################
#Made by Adventquest											#
#Use function to process the sell of leather_chestplate_19		#
#################################################################
...
execute if entity @s[scores={CHRONOTON=1440..}] run function att2:items/armor/leg_armset/leather_chestplate_20
