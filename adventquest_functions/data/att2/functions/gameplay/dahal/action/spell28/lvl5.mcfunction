...
give @s minecraft:bow{EquipmentType:"rangeWeapon",EquipmentID:"spectralbow",Rarity:"rar",Manufacturer:"traditional",Unbreakable:1,display:{Name:"\"§9Arc spectral\"","Lore":["{\"text\":\"§7Etends l'influence de ton maître\"}","{\"text\":\"§7pour 60 secondes.\"}","{\"text\":\"§7Extend your master's influence\"}","{\"text\":\"§7for 60 seconds."]},CustomModelData:1000000,Enchantments:[{id:"minecraft:power",lvl:6s},{id:"minecraft:infinity",lvl:1s}]} 1
