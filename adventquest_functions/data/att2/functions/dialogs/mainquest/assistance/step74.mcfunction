...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"Now that the two seals sealing the lair of the devastating monster are in place, I have to go back to the camp and inform Relgon. The final battle is coming up....","color":"aqua","bold":false}]}