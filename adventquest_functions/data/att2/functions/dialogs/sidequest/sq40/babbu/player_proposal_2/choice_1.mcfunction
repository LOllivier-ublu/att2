...
tellraw @s[scores={LANGUAGE=2},x=-4172,y=67,z=-5003,distance=..7] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":"","color":"aqua"},{"text":" [Dig -->]","bold":false,"color":"gray","clickEvent":{"action":"run_command","value":"/execute if score SQ40 SIDEQUEST matches 1 if entity @a[x=-4172,y=67,z=-5003,distance=..5,gamemode=adventure] run function att2:cinematic/sidequest/40/step2"},"hoverEvent":{"action":"show_text","value":"點擊這裡 - 回答 1"}}]}