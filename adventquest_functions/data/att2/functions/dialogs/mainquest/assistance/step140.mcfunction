...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"I dropped the first emerald. It activated the opening of the door at the entrance to the southwest tower. All I have to do is go ...","color":"aqua","bold":false}]}