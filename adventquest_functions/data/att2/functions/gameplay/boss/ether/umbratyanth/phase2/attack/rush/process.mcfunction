...
execute as @e[x=-5158,y=120,z=-6911,dx=82,dy=40,dz=82,type=minecraft:skeleton,tag=UmbraMinion] run data merge entity @s {Attributes:[{Name:generic.movementSpeed,Base:0.0},{Name:generic.followRange,Base:0.0}]}
