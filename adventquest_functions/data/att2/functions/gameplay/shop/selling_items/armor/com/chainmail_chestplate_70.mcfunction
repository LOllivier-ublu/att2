#################################################################
#Made by Adventquest											#
#Use function to process the sell of chainmail_chestplate_70	#
#################################################################
...
execute if entity @s[scores={CHRONOTON=19..}] run function att2:items/armor/com/chainmail_chestplate_70
