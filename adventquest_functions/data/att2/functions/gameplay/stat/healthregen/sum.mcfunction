...
execute as @s[scores={HER_FOOD=20}] if score level DIFFICULTY matches -1 run scoreboard players add @s HER_TOT 4
execute as @s[scores={HER_FOOD=20}] if score level DIFFICULTY matches 0 run scoreboard players add @s HER_TOT 2