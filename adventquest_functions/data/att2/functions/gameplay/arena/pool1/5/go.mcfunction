...
# Music management
execute if score Pool1_A5 ARENA matches 0.. as @a[x=4828,y=71,z=-5038,dx=78,dy=33,dz=76,scores={MUSIC_BOSS=0}] at @s run function att2:gameplay/boss/music_sideboss
