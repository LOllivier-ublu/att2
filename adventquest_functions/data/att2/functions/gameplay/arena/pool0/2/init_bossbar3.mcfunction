...
bossbar add minecraft:pool0_a2 {"text":"II-3/4","color":"dark_red"}
...
bossbar set minecraft:pool0_a2 name [{"text":"II-3/4","color":"red"}]
bossbar set minecraft:pool0_a2 max 50