...
give @s minecraft:bow{EquipmentType:"rangeWeapon",EquipmentID:"spectralbow",Rarity:"epi",Manufacturer:"traditional",Unbreakable:1,display:{Name:"\"§5Arc spectral\"","Lore":["{\"text\":\"§7Etends l'influence de ton maître\"}","{\"text\":\"§7pour 60 secondes.\"}","{\"text\":\"§7Extend your master's influence\"}","{\"text\":\"§7for 60 seconds."]},CustomModelData:1000000,Enchantments:[{id:"minecraft:power",lvl:10s},{id:"minecraft:infinity",lvl:1s}]} 1
