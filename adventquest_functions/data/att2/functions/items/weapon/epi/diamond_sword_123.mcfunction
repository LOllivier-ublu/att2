...
give @s minecraft:diamond_sword{EquipmentType:"meleeWeapon",Rarity:"epi",Manufacturer:"delightful",Effect:"str2_has2_hun1_res_1",display:{Name:"\"§5Ecthelion\"","Lore":["{\"text\":\"§7La force et l'honneur de l'immortel\"}","{\"text\":\"§7ne s'amenuisent guère face aux ténèbres.\"}","{\"text\":\"§7The strength and honor of the immortal hardly\"}","{\"text\":\"§7diminishes in the face of darkness.\"}","{\"text\":\"§7STR§a2 §7HAS§a2 §7HUN§a1 §7RES§c-1\"}"]},Damage:1100,Enchantments:[{id:"minecraft:smite",lvl:3s},{id:"minecraft:knockback",lvl:2s}],AttributeModifiers:[{AttributeName:generic.attack_damage,Name:generic.attack_damage,Amount:14.94,Operation:0,Slot:mainhand,UUID:[I;0,10004,0,10000]},{AttributeName:generic.attack_speed,Name:generic.attack_speed,Amount:-0.5,Operation:1,Slot:mainhand,UUID:[I;0,20004,0,10000]}]} 1