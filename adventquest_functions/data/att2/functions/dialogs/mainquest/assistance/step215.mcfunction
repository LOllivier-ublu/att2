...
tellraw @s[scores={LANGUAGE=0}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Skaolon va déposer les deux Néleptrons devant la porte d'Ouran. Allons voir si le roi accepte d'ouvrir la porte de son palais...","color":"aqua","bold":false}]}
