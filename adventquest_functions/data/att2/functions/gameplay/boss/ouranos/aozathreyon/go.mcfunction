...
execute if score Aozathreyon OURANOS matches 0.. if entity @a[x=7316,y=154,z=6554,dx=-46,dy=48,dz=46,gamemode=adventure] store result bossbar minecraft:aozathreyon max run data get entity 00000000-0000-015b-0000-00000000015b Attributes[0].Base
...
execute if score Aozathreyon OURANOS matches 0.. if entity @a[x=7316,y=154,z=6554,dx=-46,dy=48,dz=46,gamemode=adventure] unless entity @e[x=7316,y=154,z=6554,dx=-46,dy=48,dz=46,nbt={UUIDMost:347L,UUIDLeast:347L}] run function att2:gameplay/boss/ouranos/aozathreyon/victory
