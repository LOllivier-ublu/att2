...
execute if score tower_n_mech10 BILLGART matches 1 in minecraft:the_end run effect give @a[x=-1262,y=122,z=-709,dx=2,dy=4,dz=-5,gamemode=adventure] minecraft:levitation 1 0 true