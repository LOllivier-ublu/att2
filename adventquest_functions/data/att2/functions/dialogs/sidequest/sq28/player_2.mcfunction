...
tellraw @a[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"It's Korlaph. According to what is written in her diary, following the decision of Tatiana to make a dangerous ascent, his wife died. He held your mother solely responsible... So, he was in terrible pain. I know what I'm talking about, I paid the price recently, being manipulated...","color":"aqua"}]}