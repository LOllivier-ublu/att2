...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"I dropped two emeralds but no new door opened ... However, I unlocked a synergy with my earthquake spell. It seems to me that there was a passage blocked by crumbly stone on the edges of the south tower. Let's collapse it!","color":"aqua","bold":false}]}