...
execute if score winged_mech1_button_2 ANGOR matches 1 in minecraft:the_nether as @e[type=minecraft:zombie_pigman,x=3577,y=42,z=4535,dx=4,dy=3,dz=17] at @s if block ~ ~-1 ~ minecraft:red_terracotta run fill ~ ~ ~ ~ ~ ~ minecraft:fire replace minecraft:air
execute if score winged_mech1_button_1 ANGOR matches 1 in minecraft:the_nether as @e[type=minecraft:zombie_pigman,x=3577,y=42,z=4497,dx=4,dy=3,dz=-17] at @s if block ~ ~-1 ~ minecraft:red_terracotta run fill ~ ~ ~ ~ ~ ~ minecraft:fire replace minecraft:air
execute if score winged_mech1_button_1 ANGOR matches 1 in minecraft:the_nether as @e[type=minecraft:zombie_pigman,x=3577,y=42,z=4497,dx=4,dy=3,dz=-17] at @s if block ~ ~-1 ~ minecraft:quartz_block run fill ~ ~-1 ~ ~ ~-1 ~ minecraft:black_terracotta replace minecraft:quartz_block
execute if score winged_mech1_button_2 ANGOR matches 1 in minecraft:the_nether as @e[type=minecraft:zombie_pigman,x=3577,y=42,z=4535,dx=4,dy=3,dz=17] at @s if block ~ ~-1 ~ minecraft:quartz_block run fill ~ ~-1 ~ ~ ~-1 ~ minecraft:black_terracotta replace minecraft:quartz_block
