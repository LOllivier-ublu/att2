#################################################################
#Made by Adventquest											#
#Use function to process the SQ42 linda_shelly_answer1_2		#
#################################################################
...
execute as @a[distance=..10] run function att2:dialogs/sidequest/sq42/linda_shelly/player_proposal_2/answer_1