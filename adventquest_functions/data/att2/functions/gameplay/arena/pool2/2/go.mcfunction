...
execute if score Pool2_A2 ARENA matches -1 if entity @a[x=4946,y=70,z=-5296,dx=108,dy=18,dz=88,gamemode=adventure] run function att2:gameplay/arena/pool2/2/start
...
execute if score Pool2_A2 ARENA matches 0.. if entity @a[x=4946,y=70,z=-5296,dx=108,dy=18,dz=88,gamemode=adventure] unless entity @e[x=4946,y=70,z=-5296,dx=108,dy=18,dz=88,tag=ArenaBoss] run function att2:gameplay/arena/pool2/2/victory
