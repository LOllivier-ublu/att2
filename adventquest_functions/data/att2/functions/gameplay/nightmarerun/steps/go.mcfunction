...
execute if score Steps NIGHTMARERUN matches 5 positioned 6207 152 -6197 as @a[distance=..7] at @s run function att2:gameplay/nightmarerun/next_step
...
execute if score Steps NIGHTMARERUN matches 7 positioned 6203 176 -6275 as @a[distance=..5] at @s run function att2:gameplay/nightmarerun/next_step
