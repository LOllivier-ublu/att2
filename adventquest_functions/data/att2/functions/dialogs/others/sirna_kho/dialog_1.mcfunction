...
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Sirna Kho : ","color":"green","extra":[{"text":" ","color":"dark_aqua"},{"text":"<Sovereign Scale of Chaos>","color":"light_purple"},{"text":" ","color":"dark_aqua","extra":[{"text":" [看商品 -->]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/shop/seller/sirna_kho_shop_opening"},"hoverEvent":{"action":"show_text","value":"單擊此處查看 Sirna 的銷售情況。"}}]}]}