...
execute if score @s DESPAWN_TIMER matches ..20 at @s run particle minecraft:cloud ~ ~1 ~ 0 0.5 0 0.1 10 force @a
execute if score @s DESPAWN_TIMER matches ..10 at @s run particle minecraft:cloud ~ ~1 ~ 0 0.5 0 0.6 10 force @a
