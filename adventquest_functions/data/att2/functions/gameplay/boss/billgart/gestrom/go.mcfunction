...
# Music management
execute in minecraft:the_end as @a[x=-1130,y=199,z=-690,dx=-9,dy=10,dz=22,scores={MUSIC_BOSS=0}] at @s run function att2:gameplay/boss/music_demiboss
...
execute if score Gestrom BILLGART matches 0.. in minecraft:the_end if entity @a[x=-1130,y=199,z=-690,dx=-9,dy=10,dz=22,gamemode=adventure] store result bossbar minecraft:gestrom max run data get entity 00000000-0000-014b-0000-00000000014b Attributes[0].Base
...
execute if score Gestrom BILLGART matches 0.. in minecraft:the_end if entity @a[x=-1130,y=199,z=-690,dx=-9,dy=10,dz=22,gamemode=adventure] unless entity @e[x=-1130,y=199,z=-690,dx=-9,dy=10,dz=22,nbt={UUIDMost:331L,UUIDLeast:331L}] run function att2:gameplay/boss/billgart/gestrom/victory
