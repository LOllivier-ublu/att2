...
execute if score Torkant SQ52 matches 0.. if entity @a[x=-5532,y=34,z=-4164,dx=34,dy=-31,dz=44,gamemode=adventure] store result bossbar minecraft:torkant max run data get entity 00000000-0000-020c-0000-00000000020c Attributes[0].Base
...
execute if score Torkant SQ52 matches 0.. if entity @a[x=-5532,y=34,z=-4164,dx=34,dy=-31,dz=44,gamemode=adventure] unless entity @e[x=-5532,y=34,z=-4164,dx=34,dy=-31,dz=44,nbt={UUIDMost:524L,UUIDLeast:524L}] run function att2:gameplay/boss/nojelanth/torkant/victory
