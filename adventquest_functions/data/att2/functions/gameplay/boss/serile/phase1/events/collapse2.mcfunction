...
summon minecraft:fireball 2267 102 2095 {direction:[0.0,-3.0,0.0],ExplosionPower:4}
summon minecraft:fireball 2267 95 2096 {direction:[0.0,-3.0,0.0],ExplosionPower:4}
