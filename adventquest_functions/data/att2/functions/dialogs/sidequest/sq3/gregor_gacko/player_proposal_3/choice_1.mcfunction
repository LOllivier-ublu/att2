...
tellraw @s[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[我改主意了， 有什麽獎勵嗎？ -->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-034a-0000-00000000034a if entity @s[distance=..7] if score gregor_gacko_PNJ DIALOG matches 2 run function att2:cinematic/sidequest/3/gregor_gacko/answer_2_2"},"hoverEvent":{"action":"show_text","value":"點擊這裡 - 回答 1"}}]}