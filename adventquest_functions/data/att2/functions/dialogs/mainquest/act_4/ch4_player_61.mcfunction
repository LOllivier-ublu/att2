...
tellraw @a[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"Three gems, and not even a reaction yet... Three is always the magic number, though, and how many more do I need?! I hope Ithil will be able to guid me to another one...","color":"aqua"}]}