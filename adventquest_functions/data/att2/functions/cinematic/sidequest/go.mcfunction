...
execute in minecraft:the_nether if score SQ58 SIDEQUEST matches 1..99 run function att2:cinematic/sidequest/58/go
execute if score SQ59 SIDEQUEST matches 1..99 if entity @a[scores={EXPLOIT=7223..}] run function att2:cinematic/sidequest/59/end