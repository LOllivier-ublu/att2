...
tellraw @s[scores={LANGUAGE=2}] {"text":" ° ","bold":true,"color":"dark_red","extra":[{"text":"<洞穴擴張>","bold":false,"color":"gray","extra":[{"text":" [1000 Chronotons]","color":"yellow","clickEvent":{"action":"run_command","value":"/execute positioned -3780 90 -5917 if entity @s[distance=..10] run function att2:gameplay/misc/house/cave_expansion/meleim_trigger"},"hoverEvent":{"action":"show_text","value":"点击这里购买你家的洞穴扩展！"}}]}]}