...
scoreboard players operation rar RECYCLER *= 35 RECYCLER
scoreboard players operation epi RECYCLER *= 75 RECYCLER
scoreboard players operation epi_set RECYCLER *= 80 RECYCLER
scoreboard players operation epi_esc RECYCLER *= 90 RECYCLER
scoreboard players operation leg RECYCLER *= 150 RECYCLER
scoreboard players operation leg_armset RECYCLER *= 200 RECYCLER