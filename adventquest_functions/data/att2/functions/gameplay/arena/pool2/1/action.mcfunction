...
execute if score Pool2_A1_Timer ARENA matches 100 run function att2:gameplay/arena/pool2/1/summoning_minions_bee
execute if score Pool2_A1_Timer ARENA matches 500 run function att2:gameplay/arena/pool2/1/summoning_minions_creeper
execute if score Pool2_A1_Timer ARENA matches 1000 run function att2:gameplay/arena/pool2/1/summoning_minions_husk
