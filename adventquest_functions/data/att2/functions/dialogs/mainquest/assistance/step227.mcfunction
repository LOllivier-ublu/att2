...
tellraw @s[scores={LANGUAGE=1}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"gray","extra":[{"text":" : "},{"text":"There are doors that seem to be blocked. Maybe I have to find a way to unlock them.","color":"aqua","bold":false}]}