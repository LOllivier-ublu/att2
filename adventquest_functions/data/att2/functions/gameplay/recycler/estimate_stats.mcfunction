...
scoreboard players operation itemtotal_com_points RECYCLER = itemtotal_sold_com RECYCLER
...
scoreboard players operation itemtotal_unc_points RECYCLER = itemtotal_sold_unc RECYCLER
...
scoreboard players operation itemtotal_rar_points RECYCLER = itemtotal_sold_rar RECYCLER
...
scoreboard players operation itemtotal_epi_points RECYCLER = itemtotal_sold_epi RECYCLER
...
scoreboard players operation itemtotal_leg_points RECYCLER = itemtotal_sold_leg RECYCLER
