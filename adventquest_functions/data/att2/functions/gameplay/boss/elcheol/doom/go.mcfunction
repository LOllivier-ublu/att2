...
execute if score Doom SQ56 matches 0.. if entity @a[x=-5229,y=47,z=-6293,distance=..25,gamemode=adventure] store result bossbar minecraft:doom max run data get entity 00000000-0000-026c-0000-00000000026c Attributes[0].Base
...
execute if score Doom SQ56 matches 0.. if entity @a[x=-5229,y=47,z=-6293,distance=..25,gamemode=adventure] unless entity @e[x=-5229,y=47,z=-6293,distance=..25,nbt={UUIDMost:620L,UUIDLeast:620L}] run function att2:gameplay/boss/elcheol/doom/victory


# Testing if player drop the medaillon and open the secret in the academy after SQ56
execute if score SQ56 SIDEQUEST matches 100 if score secret SQ56 matches 0 if entity @a[x=-5254,y=104,z=-6338,distance=..4,gamemode=adventure,nbt={Inventory:[{id:"minecraft:nether_star",Count:1b,tag:{display:{Lore:["§4§oMedaillon"]}}}]}] run function att2:gameplay/boss/elcheol/doom/secret_medaillon