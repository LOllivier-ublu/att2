#################################################################
#Made by Adventquest											#
#Use function to process the sell of chainmail_leggings_73		#
#################################################################
...
execute if entity @s[scores={CHRONOTON=26..}] run function att2:items/armor/com/chainmail_leggings_73
