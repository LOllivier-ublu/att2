...
tellraw @s[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[在這裡， 拿 2500 Chronotons。我什至不知道如何處理這些錢， 至少它對某人有用。-->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-137a-0000-00000000137a if entity @s[distance=..7] if score babbu_PNJ DIALOG matches 1..2 run function att2:cinematic/sidequest/39/babbu/chronoton_trigger_3"},"hoverEvent":{"action":"show_text","value":"點擊這裡 - 回答 3"}}]}