...
tellraw @a[scores={LANGUAGE=0}] {"text":"°-° Walton Jones : ","color":"green","extra":[{"text":"Bon alors, montrez-moi donc ça... Hmmm je vois, je cherchais justement dans la vallée d'Eol une preuve d'existence de cet artefact, mais tous ces monstres dans le cimetière empêchait ma progression... Avec vous les problèmes semblent s'estomper rapidement sous le coup de vos armes. Nous pouvons faire une bonne équipe, retrouvez-moi donc devant les ruines de Scheströwn avant les marais d'Owsästr.","color":"dark_aqua"}]}
