...
execute if score SQ58 SIDEQUEST matches 1..99 as @a[x=-7549,y=84,z=-4176,dx=2,dy=0,dz=-2,gamemode=adventure] at @s unless entity @a[x=-7536,y=78,z=-4163,dx=-21,dy=-10,dz=-24,gamemode=adventure,tag=!Dead] as @a[distance=..30] run function att2:gameplay/boss/nojelanth/hive/display_title
...
execute if score Hive SQ58 matches -1 if entity @a[x=-7536,y=78,z=-4163,dx=-21,dy=-10,dz=-24,gamemode=adventure] run function att2:gameplay/boss/nojelanth/hive/start

# Process action of Hive
execute if score Hive SQ58 matches 0.. if entity @a[x=-7536,y=78,z=-4163,dx=-21,dy=-10,dz=-24,gamemode=adventure] run function att2:gameplay/boss/nojelanth/hive/action

# Player failed destroying Hive and died
execute if score Hive SQ58 matches 0.. unless entity @a[x=-7536,y=78,z=-4163,dx=-21,dy=-10,dz=-24,gamemode=adventure] run function att2:gameplay/boss/nojelanth/hive/fail

# Testing if Hive died
execute if score Hive SQ58 matches 0.. if entity @a[x=-7536,y=78,z=-4163,dx=-21,dy=-10,dz=-24,gamemode=adventure] unless entity @e[type=minecraft:bee,x=-7536,y=78,z=-4163,dx=-21,dy=-10,dz=-24,tag=Hive] run function att2:gameplay/boss/nojelanth/hive/victory
...
execute if score Hive SQ58 matches -2 unless entity @a[x=-7536,y=78,z=-4163,dx=-21,dy=-10,dz=-24,gamemode=adventure] unless score SQ58 SIDEQUEST matches 1..99 run function att2:gameplay/boss/nojelanth/hive/initialize