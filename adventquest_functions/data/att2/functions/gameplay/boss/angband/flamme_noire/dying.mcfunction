...
execute if score FlammeNoire ANGOR_BOSS matches 200 as @e[type=minecraft:zombified_piglin,nbt={UUID:[I;0,91,0,123]}] at @s run teleport @s 3517.3 71.6 4943 165 30
execute if score FlammeNoire ANGOR_BOSS matches 200 as @e[type=minecraft:zombified_piglin,nbt={UUID:[I;0,91,0,139]}] at @s run teleport @s 3510.7 71.6 4943 165 30
...
execute if score FlammeNoire ANGOR_BOSS matches 50 as @e[type=minecraft:zombified_piglin,nbt={UUID:[I;0,91,0,123]}] at @s run teleport @s 3517.3 46.6 4933 165 0
execute if score FlammeNoire ANGOR_BOSS matches 50 as @e[type=minecraft:zombified_piglin,nbt={UUID:[I;0,91,0,139]}] at @s run teleport @s 3510.3 46.6 4933 165 0
