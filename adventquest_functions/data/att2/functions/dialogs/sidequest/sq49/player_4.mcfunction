...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":" ","color":"aqua"},{"selector":"@a[scores={NUMEROJOUEUR=1}]"},{"text":", ","color":"aqua"}]}