...
tellraw @s {"text":"⚙ ","color":"dark_red","extra":[{"text":"Total : ","color":"gray"},{"score":{"name":"Exploration","objective":"SYMBOL"},"color":"red"},{"text":"/","color":"gray"},{"text":"1205","color":"gold"},{"text":" ⚙","color":"dark_red"}]}
