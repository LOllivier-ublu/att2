...
execute as @a[scores={SPELL_SLCT=1..10},nbt={SelectedItem:{tag:{display:{"Lore":["{\"text\":\"§4◸§8/ §4◞§c⎝§4⸜ §8\\§4◹\"}","{\"text\":\"§8⧼  §4〈§c✧§4〉  §8⧽\"}","{\"text\":\"§4◺§8\\§4 ᐠ§c⎞§4◜ §8/§4◿\"}"]}}}},tag=anyItemMalus] run function att2:gameplay/equipment/effect/le/remove_any_malus
