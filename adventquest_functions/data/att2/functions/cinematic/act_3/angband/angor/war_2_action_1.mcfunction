...
data merge entity @e[type=minecraft:zombie_pigman,nbt={UUIDMost:91L,UUIDLeast:123L},limit=1] {Rotation:[180.0f,5.0f],ArmorItems:[{},{},{},{id:"minecraft:stone_hoe",tag:{Damage:130s},Count:1}]}
data merge entity @e[type=minecraft:zombie_pigman,nbt={UUIDMost:91L,UUIDLeast:139L},limit=1] {Rotation:[180.0f,5.0f],ArmorItems:[{},{},{},{id:"minecraft:stone_hoe",tag:{Damage:130s},Count:1}]}