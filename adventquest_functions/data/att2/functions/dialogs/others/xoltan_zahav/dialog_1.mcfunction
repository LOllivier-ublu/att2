...
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Xoltan Zahav : ","color":"green","extra":[{"text":"","color":"dark_aqua","extra":[{"text":" [看商品 -->]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/shop/seller/xoltan_zahav_shop_opening"},"hoverEvent":{"action":"show_text","value":"單擊此處查看 Xoltan 的銷售情況。"}}]}]}
