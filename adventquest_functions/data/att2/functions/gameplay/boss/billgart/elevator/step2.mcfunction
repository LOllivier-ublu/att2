...
execute if score level DIFFICULTY matches -1 run summon minecraft:fireball -1239 150 -615 {ExplosionPower:3,direction:[0.0,-1.2,0.0]}
execute if score level DIFFICULTY matches 0 run summon minecraft:fireball -1239 150 -615 {ExplosionPower:4,direction:[0.0,-1.2,0.0]}
execute if score level DIFFICULTY matches 1 run summon minecraft:fireball -1239 150 -615 {ExplosionPower:5,direction:[0.0,-1.2,0.0]}
