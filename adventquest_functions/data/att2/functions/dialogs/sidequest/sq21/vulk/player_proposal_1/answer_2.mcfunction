...
tellraw @s[scores={LANGUAGE=0}] {"text":" °-° Vulk : ","color":"green","extra":[{"text":"Comment Wulk ? Non ça ne me dit rien, et quel nom ridicul... De plus, il est impossible qu'un autre forgeron puisse forger à partir de rien un tel ouvrage... Si tu trouve du temps ma requête restera toujours valide.","color":"dark_aqua"}]}
