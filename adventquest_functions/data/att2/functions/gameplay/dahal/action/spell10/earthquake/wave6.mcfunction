...
particle minecraft:falling_dust minecraft:dirt ~ ~0.5 ~ 5 0.5 5 0 120 normal
particle minecraft:falling_dust minecraft:dark_oak_wood ~ ~0.5 ~ 5 0.5 5 0 120 normal
particle minecraft:falling_dust minecraft:gray_concrete ~ ~0.5 ~ 5 0.5 5 0 120 normal
particle minecraft:item minecraft:iron_block ~ ~0.5 ~ 5 0.25 5 0.1 120 normal
particle minecraft:item minecraft:gray_concrete ~ ~0.5 ~ 5 0.25 5 0.1 120 normal
particle minecraft:item minecraft:dirt ~ ~0.5 ~ 5 0.25 5 0.1 120 normal
